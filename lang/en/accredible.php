...
$string['groupnoselection'] = 'No course selected';
$string['groupsearchplaceholder'] = 'Search course…';
$string['groupsearchhelp'] = 'Only groups from the selected brand are listed ({$a} available). Type part of a name to filter them.';
